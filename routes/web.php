...
Route::get('/demo/{slug}', 'Frontend\categoryController@pageMobile')->middleware('cache.headers:public;max_age=14400;etag');;
...
Route::get('show-crawl-data-vtc', 'crawlController@getLinkCrawlDMGK');
...
Route::get('/cart', 'AjaxController@showCart')->name('show-cart');
...
Route::get('/test-crawl', 'crawlController@checkDataCrawls_tv');
