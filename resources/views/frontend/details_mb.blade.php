                ...
                <div class="owl-carousel detail-slider" id="carousel">
                    ...
                    <div class="item img-main">
                        <a href="{{ asset('uploads/product/1731128406_may-giat-invert_main_371_1020.png_with_bgc.png') }}" data-fancybox="gallery">
                            <picture>
                                  <source media="(max-width:767px)" srcset="{{ asset('uploads/product/1731128406_may-giat-invert_main_371_1020.png_with_bgc.png') }}">
                                 
                                  <img  src="{{ asset('https://muasamtaikho.vn/uploads/product/may-giat-invert_main_371_1020.png.webp') }}" alt="{{ @$data->Name }}" >
                            </picture>
