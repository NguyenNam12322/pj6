...
@if(!empty($value))
<div class="gifts-info" style="display: none; width: 232px" data-text="{{ strlen($value->promotion) }}">
    ...
    <div class="content" style="height:auto; !important">
        ...
        <ol>
            <?php 
                $Salient_Features = _substrs($value->Salient_Features,100);

            ?>
            {!!   str_replace(['Xem thêm', 'Đặc điểm nổi bật'], '', $Salient_Features)??'' !!}
        </ol>
    </div>
