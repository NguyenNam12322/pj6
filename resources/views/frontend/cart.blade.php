                ...
                <div style="width:100%;">
                    ...
                    <div class="js-item-row product_list_cart" data-variant_id="0" data-item_id="5804" data-item_type="product">
                        ...
                        <div class="cart_col_3">
                            <div class="col_price code1"> <span class="total-item-price">{{ number_format($data->price , 0, ',', '.')}} @if( int(($data->options)['transportation_cost'])>0)  + 

                                {{ number_format(($data->options)['transportation_cost'] , 0, ',', '.') }} @endif</span>
